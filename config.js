...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~316ccad5181cd11683d494b1dd66748d:4c697a633963696948746f3d').trim() || 'Raganork~316ccad5181cd11683d494b1dd66748d:4c697a633963696948746f3d',
    ...
    NOT_ALLOWED: process.env.ALLOWED || '91,94,254,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Olly",
